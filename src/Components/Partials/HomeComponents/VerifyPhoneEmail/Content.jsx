                            ...
                            <div className="contact-form-action mb-50">
                                <form method="post">
                                    <div className="row">
                                        ...
                                        <div className="col-12">
                                            <div className="form-group">
                                                <label> کد 8 رقمی تلفن همراه<span className="text-danger">{" "} *</span></label>
                                                <input className="form-control default-font" type="text" placeholder="کد تایید 8 رقمی تلفن همراه خود را در این قسمت وارد نمایید"/>
                                            </div>
                                        </div>
